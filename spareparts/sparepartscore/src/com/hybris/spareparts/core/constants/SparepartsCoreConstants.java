 ...
 */
package com.hybris.spareparts.core.constants;

/**
 * Global class for all SparepartsCore constants. You can add global constants for your extension into this class.
 */
public final class SparepartsCoreConstants extends GeneratedSparepartsCoreConstants
{
	public static final String EXTENSIONNAME = "sparepartscore";


	private SparepartsCoreConstants()
	{
		//empty
	}

 ...
 */
package com.hybris.spareparts.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SparepartsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SparepartsFulfilmentProcessConstants.PARENT_PROCESS);

 ...
 * --- Generated at 27-Sep-2023, 8:39:15 am                     ---
 * ----------------------------------------------------------------
 */
...
/**
 * Generated class for type <code>SparepartsFulfilmentProcessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSparepartsFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return SparepartsFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, SparepartsFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}

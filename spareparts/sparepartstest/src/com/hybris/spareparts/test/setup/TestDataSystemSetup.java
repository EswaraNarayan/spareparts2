 ...
 */
package com.hybris.spareparts.test.setup;
...
import com.hybris.spareparts.test.constants.SparepartsTestConstants;
import com.hybris.spareparts.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SparepartsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sparepartstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sparepartstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sparepartstest/import/cstickets.impex");
			...
			importImpexFile(context, "/sparepartstest/import/csquotes.impex");
		}
	}
}

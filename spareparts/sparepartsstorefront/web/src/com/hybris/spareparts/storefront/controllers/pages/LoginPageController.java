 ...
 */
package com.hybris.spareparts.storefront.controllers.pages;
...
import com.hybris.spareparts.storefront.controllers.ControllerConstants;
import com.hybris.spareparts.storefront.forms.SparepartRegisterForm;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	@Resource(name = "sparepartregistrationValidator")
	private Validator sparepartregistrationValidator;

	@Resource(name = "sparepartCustomerFacade")
	private SparepartCustomerFacade sparepartCustomerFacade;

	protected SparepartCustomerFacade getsparepartCustomerFacade()
	{
		return sparepartCustomerFacade;
	}

	protected Validator getsparepartregistrationValidator()
	{
		return sparepartregistrationValidator;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		return getDefaultSparepartLoginPage(loginError, session, model);
	}
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer,
			final SparepartRegisterForm form, final BindingResult bindingResult, final Model model, final HttpServletRequest request,
			final HttpServletResponse response, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		getsparepartregistrationValidator().validate(form, bindingResult);
		return processSparepartRegisterUserRequest(referer, form, bindingResult, model, request, response, redirectModel);
	}

	protected String processSparepartRegisterUserRequest(final String referer, final SparepartRegisterForm form,
			...
			final HttpServletResponse response, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		try
		{
			getsparepartCustomerFacade().register(data);
	...
	protected String getDefaultSparepartLoginPage(final boolean loginError, final HttpSession session, final Model model)
			throws CMSItemNotFoundException
	{
		final LoginForm loginForm = new LoginForm();
		model.addAttribute(loginForm);
		model.addAttribute(new SparepartRegisterForm());
		model.addAttribute(new GuestForm());

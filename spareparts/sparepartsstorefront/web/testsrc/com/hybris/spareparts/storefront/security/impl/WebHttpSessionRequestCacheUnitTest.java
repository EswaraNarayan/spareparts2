...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparepartsstorefront/electronics/en",
						"https://electronics.local:9002/sparepartsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparepartsstorefront/electronics/en",
						"https://electronics.local:9002/sparepartsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sparepartsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sparepartsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sparepartsstorefront/electronics/en",
						"https://electronics.local:9002/sparepartsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sparepartsstorefront",
						"https://electronics.local:9002/sparepartsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sparepartsstorefront",
						"https://electronics.local:9002/sparepartsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparepartsstorefront/electronics/en",
						"https://electronics.local:9002/sparepartsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
